...
# Piece Stuff
var possible_pieces = [
	load("res://Pieces/Redstone.tscn"),
	load("res://Pieces/Emerald.tscn"),
	load("res://Pieces/BrownIron.tscn"),
	load("res://Pieces/Coal.tscn"),
	load("res://Pieces/Diamond.tscn"),
	load("res://Pieces/Iron.tscn"),
	load("res://Pieces/Gold.tscn"),
	load("res://Pieces/Silver.tscn")
]
